                        ...
                        <div className='row '>
                            ...
                            <div className='col-12    ' >
                                ...
                                <div className='col-12 top label  con margn_top '>
                                  ...
                                  <div className='col'>
                                  <TextField placeholder='Add  Sub State' id="outlined-basic" variant="outlined"   value={NameState } style={{minWidth: 190 , fontSize:15}}
                                        onChange={handleName} />
                                  </div>
                                </div>
                                <div className='col-12 top label  con'>
                                 ...
                                 <div className='col'>
                                 <TextField placeholder='Add  Sub State' id="outlined-basic" variant="outlined"   value={State}style={{minWidth: 190 , fontSize:15}}
